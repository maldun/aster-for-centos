...
QA_SKIP_BUILD_ROOT=1 rpmbuild -ba codeaster-frontend.spec --define "version $FRONTEND_VER" --define "aster_libs $ASTER_LIBS" --define "aster_root $ASTER_BASE" --define "metis_version $METIS_VER"
